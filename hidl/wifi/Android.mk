...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi-service-lazy.light.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi-service-lazy.light
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi-service-lazy.light.rc
